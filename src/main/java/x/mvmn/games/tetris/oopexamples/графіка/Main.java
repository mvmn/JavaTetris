    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 255; i++) {
            фігури.add(new Багатокутник(new Координати[] {
                    new Координати(106 + i * 2, 134),
                    new Координати(126 + i * 2, 120),
                    new Координати(145 + i * 2, 127),
                    new Координати(154 + i * 2, 146),
                    new Координати(143 + i * 2, 166),
                    new Координати(121 + i * 2, 171),
                    new Координати(106 + i * 2, 159)
                }, new Color(i, 255 - i, i)));
        }
